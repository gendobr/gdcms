...
var tinymce_settings = {
    ...
    theme_advanced_buttons1: "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,formatselect,|,styleprops,|,cite,abbr,acronym,del,ins,attribs,|,visualchars,nonbreaking,pagebreak", //,fontselect,fontsizeselect justifyfull,
...
function insert_link(text, url, attributes) {
    ...
    var html = "<a href=\"" + url + "\" " + attrHtml + ">" + text + "</a>";
