...
//  function add($p_filelist, $p_add_dir="", $p_remove_dir="")
  ...
  function extract(/* options */)
  {
    ...
    if ($v_size > 0) {
      // ----- Get the arguments
      $v_arg_list = func_get_args(); /////////$v_arg_list = &func_get_args();
      ...
      switch ($p_options_list[$i]) {
        ...
        case PCLZIP_OPT_ADD_PATH :
          ...
          if (($i+1) >= $p_size) {
            ...
            // ----- Return
            //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, ::errorCode(), ::errorInfo());
            return pclzip::errorCode();
          }
...
//    $p_header['external'] = (is_file($p_filename)?0xFE49FFE0:0x41FF0010);
  ...
  if(!isset($p_local_header['filename_len'])) $p_local_header['filename_len']='';
