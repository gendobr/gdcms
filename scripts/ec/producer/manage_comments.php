...
// ------------------ delete - begin -------------------------------------------
   if(   isset($input_vars['ec_producer_comment_delete'])
      && isset($input_vars['ec_producer_comment'])
      && is_array($input_vars['ec_producer_comment'])
   )
   {
      $query=Array();
...
//--------------------------- get list -- begin --------------------------------
  ...
  $re->add_field( $field='ec_producer_comment.ec_producer_comment_id'
                 ,$alias='ec_producer_comment_id'
                 ,$type ='id:hidden=no'
                 ,$label='Comment #'
                 ,$_group_operation=false);
  ...
  $re->add_field( $field='ec_producer_comment.ec_producer_comment_sender_name'
                 ,$alias='ec_producer_comment_sender_name'
                 ,$type ='string'
                 ,$label=text('Comment_sender')
                 ,$_group_operation=false);

  $re->add_field( $field='ec_producer_comment.ec_producer_comment_body'
                 ,$alias='ec_producer_comment_body'
                 ,$type ='string'
                 ,$label=text('Comment_content')
                 ,$_group_operation=false);

  $re->add_field( $field='ec_producer_comment.ec_producer_comment_datetime'
                 ,$alias='ec_producer_comment_datetime'
                 ,$type ='datetime'
                 ,$label=text('Date')
                 ,$_group_operation=false);
...
# ---------------------- draw list - begin -------------------------------------
  $tor="
     ...
     // ------------------------- filter -- begin ------------------------------
        ...
        # $alias='ec_producer_comment_id'
        $fld=$response['fields']['ec_producer_comment_id'];
        //prn($fld);
        ...
        # $alias='ec_producer_comment_sender_name'
        $fld=$response['fields']['ec_producer_comment_sender_name'];
        //prn($fld);
        $value = isset($response['fields'][$fld['alias']]['filter']['form_element_value'])?$response['fields'][$fld['alias']]['filter']['form_element_value']:'';
        $tor.="
               <tr>
        ...
        # $alias='ec_producer_comment_body'
        $fld=$response['fields']['ec_producer_comment_body'];
        //prn($fld);
        $value = isset($response['fields'][$fld['alias']]['filter']['form_element_value'])?$response['fields'][$fld['alias']]['filter']['form_element_value']:'';
        $tor.="
               <tr>
        ...
        ";
         ...
         # $alias='ec_producer_comment_datetime'
           $fld=$response['fields']['ec_producer_comment_datetime'];
           //prn($fld);
           $value = isset($response['fields'][$fld['alias']]['filter']['form_element_value'])?$response['fields'][$fld['alias']]['filter']['form_element_value']:'';
           $tor.="
               <tr>
     ...
     ".hidden_form_elements('^ec_producer|^submit')."
     ...
     <tr>
         ...
         <th align=center valign=bottom>
               <b>{$response['fields']['ec_producer_comment_id']['label']}</b><br>
               <nobr>
               <a href=\"{$response['fields']['ec_producer_comment_id']['url_order_asc']}\">V</a>
               <a href=\"{$response['fields']['ec_producer_comment_id']['url_order_desc']}\">&Lambda;</a>
               </nobr>
         </th>
         <th align=center valign=bottom>
         ...
         <th align=center valign=bottom>
               <b>{$response['fields']['ec_producer_comment_datetime']['label']}</b><br>
               <a href=\"{$response['fields']['ec_producer_comment_datetime']['url_order_asc']}\">V</a>
               <a href=\"{$response['fields']['ec_producer_comment_datetime']['url_order_desc']}\">&Lambda;</a>
         </th>

         <th align=center valign=bottom>
               <b>{$response['fields']['ec_producer_comment_sender_name']['label']}</b><br>
               <a href=\"{$response['fields']['ec_producer_comment_sender_name']['url_order_asc']}\">V</a>
               <a href=\"{$response['fields']['ec_producer_comment_sender_name']['url_order_desc']}\">&Lambda;</a>
         </th>
     </tr>\n";
     // ------------------------- header -- end --------------------------------
     // ------------------------- rows -- begin --------------------------------
     //prn($response['fields']['ec_producer_currency']['options']);
     foreach($response['rows'] as $row_id=>$row)
     {
       $tor.="<tr class=row>
               <td align=center valign=top rowspan=2>
                <input type=checkbox name=ec_producer_comment[{$row['ec_producer_comment_id']}] value=\"{$row['ec_producer_comment_id']}\">
               </td>
           <td align=left valign=top rowspan=2>&nbsp;{$row['ec_producer_comment_id']}</td>
           <td align=left valign=top class='b-b b-r'><a href='index.php?action=ec/producer/edit&site_id={$row['site_id']}&ec_producer_id={$row['ec_producer_id']}'>{$row['ec_producer_title']}</a></td>
           <td align=left valign=top class='b-b b-r b-l'>&nbsp;{$row['ec_producer_comment_datetime']}</td>
           <td align=left valign=top class='b-b b-l'>&nbsp;{$row['ec_producer_comment_sender_name']}</td>
       </tr>
       <tr>
          <td colspan=3 class='b-t' style='color:gray;'>{$row['ec_producer_comment_body']}<td>
       </tr>
      ";
     ...
     $tor.="<tr>
             <td colspan=\"6\" align=right style='border:none;'>
               <input type=submit name=ec_producer_comment_delete value=\"".text('Delete')."\" style='width:30%;'>
            </td>
            </tr>";
     // ------------------------- rows -- end ----------------------------------
     // ------------------------- paging - begin -------------------------------
...
$input_vars['page_header'] = $this_site_info['title'] .' - '. text('EC_producer_manage_comments');
