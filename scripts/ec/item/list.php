...
//--------------------------- get list -- begin --------------------------------
  ...
  $re->from="{$table_prefix}ec_item AS ec_item";
  ...
  if($category_id>0){
     $re->add_where(" ec_item.ec_item_id IN(select distinct ec_item_id from {$table_prefix}ec_item_category where ec_category_id={$category_id}) ");
  }
  /*
