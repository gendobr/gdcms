            ...
            <div class=\"row\">
                ...
                <div class=\"col-md-4\">
                    <div class=\"product-category\"><a href=\"".
                         ...
                         (isset($gambit_category_options[$product['idCategory']])?$gambit_category_options[$product['idCategory']]:"Категория {$product['idCategory']}")
                    ."</a></div>
                    ...
                    :"Ед.гзм. {$product['idUnit']}" )
                    ."</div>
                </div>
            </div>
            <div>
                <button type=\"button\" class=\"addToCardBtn btn btn-success\">В корзину</button>
            </div>
                <br>
