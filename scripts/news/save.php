    ...
    if($all_is_ok)
    {
       ...
       # ------------------ send notification - begin --------------------------
         ...
         if(is_array($_REQUEST['notify']))
         {
           ...
           function allowed_chars($str){return wordwrap(preg_replace('/[^ 1234567890\-_àáâãäåæçèéêëìíîïðñòóôõö÷øùþýÿüú¸.\?\!ÀÁÂÃÄÅ¨ÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ÙÀÞßÜÚQWERTYUIOPASDFGHJKL;:\'ZXCVBNM,\/qwertyuiopasdfghjklzxcvbnm³¿º²¯ª´¥@%]/',' ',strip_tags($str)),60,'<br>');}
           $tmp_news_info=Array();
