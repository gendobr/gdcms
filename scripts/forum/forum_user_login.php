...
function login_info()
{
  ...
  # ------------------ do login - begin ----------------------------------------
    ...
    {
      $_SESSION['forum_user_info']=db_getonerow("SELECT * FROM {$GLOBALS['table_prefix']}forum_user WHERE user_login='".DbStr($GLOBALS['input_vars']['un'])."' AND user_password='".md5($GLOBALS['input_vars']['pw'])."'");
