...
// -------------------------- move children - begin ----------------------------
   if(isset($input_vars['move_down'])) $this_category->move_down((int)$input_vars['move_down']);
   if(isset($input_vars['move_up']  )) $this_category->move_up((int)$input_vars['move_up']);
// -------------------------- move children - end ------------------------------
# ------------------------- delete - begin -------------------------------------
...
#  ---------------------------- adjust nodes - begin ---------------------------
   ...
   foreach($cnt as $i) $this_category->parents[$i]=adjust($this_category->parents[$i],$this_category->id);

   $cnt=array_keys($this_category->children);
   foreach($cnt as $i) $this_category->children[$i]=adjust($this_category->children[$i],$this_category->id);
...
foreach($this_category->parents as $row)
{
  ...
  $tor.=">{$row['category_code']} {$row['title_short']}</a><br>
...
$tor.="
  ...
  $input_vars['page_header']  = text('Category')." {$this_category->info['category_title']}";
