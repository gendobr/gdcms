...
//--------------------------- get list -- begin --------------------------------
  ...
  $re->from="
   ...
   INNER JOIN {$table_prefix}rsssourceitem AS rsssourceitem
...
//rsssourceitem_lang         varchar(3)
  $LL = join('&',GetAssociatedArray(db_execute("SELECT rsssourceitem_lang,CONCAT(rsssourceitem_lang,'=',rsssourceitem_lang) FROM {$table_prefix}rsssourceitem WHERE site_id={$site_id}")));
