...
$query = "SELECT * FROM <<tp>>news_subscriber WHERE site_id={$site_id} AND news_subscriber_is_valid ORDER BY news_subscriber_id ASC LIMIT $start, $N";
...
if($subscribers){
    ...
    foreach ($subscribers as $subscriber_info) {
        ...
        \e::db_execute("UPDATE <<tp>>news_subscriber SET news_subscriber_code='$code' WHERE news_subscriber_id={$subscriber_info['news_subscriber_id']}");
