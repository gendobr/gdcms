...
<? /* =$input_vars['page_start'] */ ?>
<!-- початок великої світлозеленої таблиці -->
...
<!--початок  таблиці, яка містить лівий блок і великий блок -->
<table border="0" cellpadding="0" cellspacing="0" width="100%" align=center>
<tr><td valign="top" class="a">

<!--початок  великого текстового блоку -->
...
<!-- кінець великого текстового блоку -->

</td></tr></table>

<!-- кінець  таблиці, яка містить лівий блок і великий блок -->

<br>

</td></tr>
</table>
<!-- кінець великої світлозеленої таблиці -->
