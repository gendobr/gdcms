...
$iframe ='';
    ...
    $iframe.='
    <h4>Страница просмотра импортированных новостей</h4>
    <div style="color:blue;padding:10px; width:90%; overflow:scroll;height:80pt;border:1px solid red;"><pre>'.
    checkStr("
        <a href=\"".site_root_URL."/index.php?action=rss_aggregator/view&site_id={$site_id}&lang={$_SESSION['lang']}\">Импортированные из RSS новости</a>
    ").'</pre></div>';

    $iframe.='
    <h4>Блок "импортированные новости" для вставки в страницу</h4>
    <div style="color:blue;padding:10px; width:90%; overflow:scroll;height:80pt;border:1px solid red;"><pre>'.
    checkStr("
...
<title><?=  get_langstring($this_site_info['title'])?> - Імпортовані записи RSS</title>
