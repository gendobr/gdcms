...
switch($input_vars['view'])
{
    case 'news':
        ...
        $tor.="
        <a href=\"index.php?action=site/page/link_selector&site_id={$this_site_info['id']}\">Вибір URL</a>/ {$text['News']}<br><br>
    ...
    case 'pages':
        ...
        $tor.="
        <a href=\"index.php?action=site/page/link_selector&site_id={$this_site_info['id']}\">Вибір URL</a>/ {$text['Pages']}<br><br>
